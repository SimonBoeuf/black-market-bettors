...
ActiveRecord::Schema.define(version: 20150827163509) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "events", force: true do |t|
    t.integer  "frame_id",       limit: 8
  ...
  create_table "games", force: true do |t|
    ...
    t.string   "region"
    t.integer  "season"
    t.integer  "blue_team_id",  limit: 8
    t.integer  "red_team_id",   limit: 8
    t.integer  "timeline_id",   limit: 8
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "participants", force: true do |t|
    t.integer  "champion_id",               limit: 8
    t.integer  "game_id",                   limit: 8
    t.integer  "highestAchievedSeasonTier"
    t.integer  "spell1_id",                 limit: 8
    t.integer  "spell2_id",                 limit: 8
  ...
  create_table "static_data_masteries", force: true do |t|
    t.integer  "image_id",     limit: 8
    t.string   "name"
    t.integer  "mastery_tree", limit: 8
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "timelines", force: true do |t|
    t.integer  "frame_interval", limit: 8
    t.integer  "game_id",        limit: 8
    t.datetime "created_at"
    t.datetime "updated_at"
  end
